...
class SILab2Test {
    ...
    void checkEveryBranch() {
        ...
        //6
        exception = assertThrows(RuntimeException.class, () -> SILab2.checkCart(create(new Item("Damjan", "0a34b", 20, 0.5f)), 1));
        assertTrue(exception.getMessage().contains("Invalid character in item barcode!"));

        //7
        assertFalse(SILab2.checkCart(create(new Item("Damjan", "123456", 500, -1)), 2));
